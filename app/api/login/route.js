            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 550px; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(15,23,42,0.08);">
              ...
              <tr>
                <td style="background: linear-gradient(135deg, #0f172a 0%, #334155 100%); padding: 10% 6% 8%; text-align: center;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                      <td align="center">
                        <p style="color: rgba(255,255,255,0.7); font-size: clamp(12px, 3vw, 14px); margin: 0; font-weight: 400; letter-spacing: 0.03em;">kinyui boys Senior School Admin System</p>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td style="background: #0f172a; padding: 8% 6%; text-align: center;">
                  <p style="color: #ffffff; font-size: clamp(14px, 3.5vw, 16px); font-weight: 700; margin: 0 0 4px; letter-spacing: -0.01em;">kinyui boys Senior School</p>
                  <div style="width: 40px; height: 2px; background: #475569; margin: 12px auto;"></div>
                  <p style="color: #64748b; font-size: clamp(10px, 2.5vw, 11px); margin: 0;">© ${new Date().getFullYear()} kinyui boys Senior School. All rights reserved.</p>
                </td>
              </tr>
