...
async function sendTeacherInquiryEmail(payload, referenceNumber) {
  ...
  const mailOptions = {
    ...
    to: teacherEmail,
    subject: `${SCHOOL_NAME} - New Inquiry: ${subject} (${referenceNumber})`,
    html: `
      <!doctype html>
      <html lang="en">
        <head>
...
async function sendInquirerConfirmationEmail(toEmail, name, teacherName, referenceNumber) {
  const mailOptions = {
    from: {
      name: `${SCHOOL_NAME} - Consultation Desk`,
      address: process.env.EMAIL_USER,
    },
    to: toEmail,
    subject: `Inquiry received - ${SCHOOL_NAME} (Ref ${referenceNumber})`,
    html: `
      <!doctype html>
      <html lang="en">
        <head>
                    ...
                    <td style="padding:22px;">
                      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; color:#111827; line-height:1.6;">
                        ...
                        <p style="margin:0 0 14px 0; color:#374151;">
                          ...
                          The staff member will respond as soon as possible.
                        </p>
