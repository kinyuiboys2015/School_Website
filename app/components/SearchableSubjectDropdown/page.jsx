  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <button
        ...
        className={`flex min-h-12 w-full items-center justify-between rounded-xl border border-slate-200 bg-white px-4 text-left text-sm font-semibold text-slate-800 shadow-sm transition focus:outline-none focus:ring-4 ${
          isTeal
            ? "hover:border-teal-300 focus:border-teal-500 focus:ring-teal-100"
            : "hover:border-amber-300 focus:border-amber-500 focus:ring-amber-100"
        }`}
      >
