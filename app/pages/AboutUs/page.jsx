    ...
    <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
      ...
      <div className="lg:col-span-6 relative group order-1 lg:order-1">
        <div className="relative">
          {/* Main Image with a thick offset border */}
          ...
          <div className="absolute -bottom-6 -right-6 lg:right-12 z-20 bg-white/80 backdrop-blur-xl p-6 rounded-[2rem] border border-white shadow-2xl max-w-[240px]">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">Our Compass</span>
            </div>
      ...
      {/* CONTENT SIDE: Visionary Messaging */}
      <div className="lg:col-span-6 order-2">
        <div className="mb-12">
          <span className="inline-flex items-center gap-2 px-4 py-2 mb-6 text-[10px] font-black tracking-[0.3em] text-amber-600 uppercase bg-amber-50 rounded-full border border-amber-100">
