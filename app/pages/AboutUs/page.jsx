      ...
      <section className="relative min-h-[90vh] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 md:pb-24">
          <div className="max-w-3xl">
            ...
            <p className="text-sm sm:text-base md:text-lg text-slate-200 max-w-2xl leading-relaxed mb-8 font-medium">
          ...
          <div className="mt-10 sm:mt-14 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            ...
            <AnimatedCounter value="45" label="Awards Won" icon={Award} />
              ...
              <div className="space-y-4">
                {([
                  ...
                  <div key={i} className="group flex items-start gap-6 p-5 rounded-3xl transition-all duration-300 hover:bg-slate-50 border border-transparent hover:border-slate-200">
                    ...
                    <div>
                      <h4 className="font-black text-slate-900 text-sm sm:text-base uppercase tracking-tight mb-1">{item.title}</h4>
      ...
      <section className="py-16 sm:py-28 px-4 sm:px-6 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 md:mb-24 relative">
            ...
            <p className="mt-6 text-slate-600 font-bold text-xs sm:text-sm tracking-[0.2em] uppercase">
              ...
              <div className="relative h-full w-full overflow-hidden rounded-[2.5rem] border-4 border-white shadow-xl">
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md p-6 rounded-2xl border border-white/50 shadow-lg">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-[10px] font-black text-amber-700 uppercase tracking-widest">Enrollment</span>
                    <span className="text-[10px] font-bold text-green-700 bg-green-50 px-2 py-0.5 rounded-full">Active</span>
                  </div>
                  <div className="flex items-end gap-2">
                    <span className="text-3xl sm:text-4xl font-black text-slate-900">400+</span>
                    <span className="text-xs font-medium text-slate-700 mb-1.5">Future Leaders</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                ...
                <div className="relative aspect-[4/5] overflow-hidden rounded-lg border-[12px] border-white shadow-2xl">
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-4 rounded-2xl flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-white font-black text-xs sm:text-sm uppercase tracking-wider">The Kinyui Way</p>
                        <p className="text-white/80 text-[10px] sm:text-xs">Forging leaders since 1976</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-7 order-1 lg:order-2">
              <div className="mb-12">
                <h4 className="text-amber-700 font-black text-[10px] uppercase tracking-[0.3em] mb-4">Our Foundation</h4>
              ...
              <div className="relative space-y-8 before:absolute before:left-[19px] before:top-2 before:bottom-2 before:w-[2px] before:bg-slate-200">
                {([
                  ...
                  <div key={i} className="relative pl-12 group">
                    ...
                    <div className="pb-2">
                      <h5 className="font-black text-slate-900 text-base sm:text-lg uppercase tracking-tight group-hover:text-amber-600 transition-colors">
                        {val.title}
                      </h5>
              ...
              <div className="sticky top-8 h-full min-h-[450px] bg-white rounded-[2.5rem] border border-slate-200 p-3 shadow-xl overflow-hidden transition-all duration-500 hover:border-amber-400/50">
                ...
                <div className="mt-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-orange-600 text-white font-bold rounded-xl hover:bg-orange-700 transition-colors shadow-lg shadow-orange-600/20 text-xs sm:text-sm"
                  >
            ...
            <div className="lg:w-2/3 p-10 md:p-16 flex flex-col justify-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
                ...
                <div className="group">
                  ...
                  <h4 className="text-amber-700 font-black text-[10px] uppercase tracking-[0.2em] mb-3">Code of Conduct</h4>
                ...
                <div className="group">
                  ...
                  <h4 className="text-orange-700 font-black text-[10px] uppercase tracking-[0.2em] mb-3">Brotherhood Support</h4>
                  <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-4 leading-tight">
