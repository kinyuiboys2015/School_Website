  ...
  const fetchData = async (isRefresh = false) => {
    try {
      ...
      const visibleLeadership = (staffData.staff || [])
        ...
        .sort((a, b) => {
          const roleA = LEADERSHIP_ORDER[a.role] || 99;
          const roleB = LEADERSHIP_ORDER[b.role] || 99;
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <p className="text-[11px] font-black uppercase tracking-[0.3em] text-blue-300">Kinyui Boys Senior School</p>
