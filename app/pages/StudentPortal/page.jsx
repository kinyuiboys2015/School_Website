...
// and mobile menu toggle. Features Kinyui Boys' School theme with maroon and dark amber colors.
...
function ModernStudentHeader({ 
  ...
  // Creates personalized color combinations using school's maroon and dark amber theme
  const getGradientColor = (name) => {
    const char = name.trim().charAt(0).toUpperCase();
    const gradients = {
      A: "bg-gradient-to-r from-maroon-800 to-dark-amber-700",
      B: "bg-gradient-to-r from-dark-amber-700 to-maroon-800",
      C: "bg-gradient-to-r from-maroon-900 to-dark-amber-600",
      D: "bg-gradient-to-r from-dark-amber-800 to-maroon-700",
      E: "bg-gradient-to-r from-maroon-700 to-dark-amber-800",
      F: "bg-gradient-to-r from-dark-amber-600 to-maroon-900",
      G: "bg-gradient-to-r from-maroon-950 to-dark-amber-700",
      H: "bg-gradient-to-r from-dark-amber-700 to-maroon-950",
      I: "bg-gradient-to-r from-maroon-800 to-dark-amber-600",
      J: "bg-gradient-to-r from-dark-amber-600 to-maroon-800",
      K: "bg-gradient-to-r from-maroon-900 to-dark-amber-700",
      L: "bg-gradient-to-r from-dark-amber-700 to-maroon-900",
      M: "bg-gradient-to-r from-maroon-700 to-dark-amber-600",
      N: "bg-gradient-to-r from-dark-amber-600 to-maroon-700",
      O: "bg-gradient-to-r from-maroon-950 to-dark-amber-800",
      P: "bg-gradient-to-r from-dark-amber-800 to-maroon-950",
      Q: "bg-gradient-to-r from-maroon-800 to-dark-amber-700",
      R: "bg-gradient-to-r from-dark-amber-700 to-maroon-800",
      S: "bg-gradient-to-r from-maroon-900 to-dark-amber-600",
      T: "bg-gradient-to-r from-dark-amber-600 to-maroon-900",
      U: "bg-gradient-to-r from-maroon-700 to-dark-amber-800",
      V: "bg-gradient-to-r from-dark-amber-800 to-maroon-700",
      W: "bg-gradient-to-r from-maroon-950 to-dark-amber-700",
      X: "bg-gradient-to-r from-dark-amber-700 to-maroon-950",
      Y: "bg-gradient-to-r from-maroon-800 to-dark-amber-600",
      Z: "bg-gradient-to-r from-dark-amber-600 to-maroon-800",
    };
    return gradients[char] || "bg-gradient-to-r from-maroon-800 to-dark-amber-700";
  };
  ...
  const getViewIcon = (view) => {
    switch(view) {
      case 'home': return <FaHome className="text-dark-amber-600" />;
      case 'results': return <FaChartBar className="text-dark-amber-600" />;
      case 'resources': return <FaFolder className="text-dark-amber-600" />;
      case 'guidance': return <FaComments className="text-dark-amber-600" />;
      case 'fees': return <FaDollarSign className="text-dark-amber-600" />;
      default: return <FaHome className="text-dark-amber-600" />;
    }
  };
  ...
  return (
    <>
      ...
      <header className="bg-gradient-to-r from-maroon-950 via-maroon-900 to-dark-amber-900 border-b border-dark-amber-700/30 shadow-xl sticky top-0 z-30">
        <div className="container mx-auto px-3 xs:px-4 sm:px-6">
          <div className="flex items-center justify-between h-14 sm:h-16 md:h-20">
            ...
            <div className="flex items-center gap-2 sm:gap-3 md:gap-5">
              ...
              >
                {isMenuOpen ? 
                  <FaTimes className="text-dark-amber-400 w-4 h-4 sm:w-5 sm:h-5" /> : 
                  <FaBars className="text-dark-amber-400 w-4 h-4 sm:w-5 sm:h-5" />
                }
              </button>
              ...
              {student && (
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="relative group">
                    ...
                    />
                    <div className="relative w-9 h-9 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-full flex items-center justify-center font-bold text-black text-base sm:text-lg md:text-xl bg-gradient-to-br from-maroon-900 to-dark-amber-800 border-2 border-dark-amber-500 shadow-lg">
                  ...
                  <div className="hidden xs:flex flex-col">
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                      <span className="text-xs sm:text-sm text-dark-amber-300 mobile-text-truncate max-w-[100px] sm:max-w-none">
                        {student.form} • {student.stream}
                      </span>
                      <span className="w-2 h-2 sm:w-2.5 sm:h-2.5 bg-gradient-to-r from-dark-amber-500 to-dark-amber-600 rounded-full animate-pulse"></span>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="lg:hidden flex items-center gap-2 sm:gap-3">
              ...
              <div className="max-w-[140px] sm:max-w-none">
                ...
                <p className="text-xs text-dark-amber-300 hidden sm:block">Kinyui Boys' Portal</p>
              </div>
            </div>

            {/* School Badge - Description: Desktop-only display of school name and branding */}
            <div className="hidden lg:flex items-center gap-2">
              <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white/10 rounded-full border border-dark-amber-600/30">
                <div className="w-1.5 h-1.5 bg-dark-amber-500 rounded-full animate-pulse" />
                <span className="text-[10px] font-black text-dark-amber-300 uppercase tracking-wider">KINYUI BOYS'</span>
                <FaShieldHalved className="w-3 h-3 text-dark-amber-500" />
              </div>
            </div>
          </div>
        </div>
...
function ModernHomeView({ student, feeBalance, feeLoading, token }) {
  ...
  const stats = [
    { 
      ...
      icon: <FaUser className="text-base sm:text-lg md:text-xl text-white" />, 
      gradient: 'from-maroon-800 to-dark-amber-700',
      bgGradient: 'from-maroon-900 to-dark-amber-800'
    },
    { 
      label: 'Stream', 
      value: student?.stream || 'N/A', 
      icon: <FaBook className="text-base sm:text-lg md:text-xl text-white" />, 
      gradient: 'from-dark-amber-800 to-maroon-800',
      bgGradient: 'from-dark-amber-900 to-maroon-900'
    },
    { 
      label: 'Admission No', 
      value: student?.admissionNumber || 'N/A', 
      icon: <FaAward className="text-base sm:text-lg md:text-xl text-white" />, 
      gradient: 'from-maroon-900 to-dark-amber-600',
      bgGradient: 'from-maroon-950 to-dark-amber-800'
    },
    { 
      label: 'Academic Year', 
      value: new Date().getFullYear().toString(),
      icon: <FaCalendar className="text-base sm:text-lg md:text-xl text-white" />, 
      gradient: 'from-dark-amber-700 to-maroon-800',
      bgGradient: 'from-dark-amber-800 to-maroon-900'
    },
  ];
  ...
  const quickActions = [
    {
      ...
      icon: <FiBookOpen className="text-lg sm:text-xl md:text-2xl text-white" />,
      gradient: 'from-maroon-800 to-dark-amber-700',
      bgGradient: 'from-maroon-900 to-dark-amber-800',
    ...
    },
    {
      ...
      icon: <FaChartLine className="text-lg sm:text-xl md:text-2xl text-white" />,
      gradient: 'from-dark-amber-800 to-maroon-800',
      bgGradient: 'from-dark-amber-900 to-maroon-900',
    ...
    },
    {
      ...
      icon: <FaUserFriends className="text-lg sm:text-xl md:text-2xl text-white" />,
      gradient: 'from-maroon-900 to-dark-amber-600',
      bgGradient: 'from-maroon-950 to-dark-amber-800',
  ...
  return (
    <div className="space-y-4 sm:space-y-6 md:space-y-8 mobile-scroll-hide">
      ...
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl">
        <div className="absolute inset-0 bg-gradient-to-r from-maroon-950 via-maroon-900 to-dark-amber-900 opacity-100"></div>
        ...
        <div className="relative p-4 sm:p-6 md:p-8 text-white">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 md:gap-5 mb-3 sm:mb-4 md:mb-6">
            <div className="p-3 sm:p-4 bg-white bg-opacity-20 rounded-xl sm:rounded-2xl backdrop-blur-sm w-fit">
              <FaRocket className="text-xl sm:text-2xl md:text-3xl text-dark-amber-400" />
            </div>
            <div className="flex-1">
              <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold leading-tight text-white">
                Welcome back, {student?.fullName?.split(" ")[0] || "Student"}! 🚀
              </h2>
              <p className="text-dark-amber-200 text-xs sm:text-sm md:text-base lg:text-lg mt-1 sm:mt-2 max-w-2xl">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 md:gap-4 mt-3 sm:mt-4 md:mt-6">
            <span className="inline-flex items-center gap-1 sm:gap-2 bg-white bg-opacity-20 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full backdrop-blur-sm text-xs sm:text-sm font-bold text-white">
              <HiSparkles className="text-dark-amber-400 text-xs sm:text-sm md:text-base" />
              Active Student
            </span>
            <span className="inline-flex items-center gap-1 sm:gap-2 bg-white bg-opacity-20 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full backdrop-blur-sm text-xs sm:text-sm font-bold text-white">
              <FaCalendarCheck className="text-dark-amber-300 text-xs sm:text-sm md:text-base" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4 lg:gap-5">
        {stats.map((stat, index) => (
          <div key={index} className="group relative w-full">
            <div 
              className={`absolute inset-0 bg-gradient-to-r ${stat.gradient} rounded-lg sm:rounded-xl md:rounded-2xl blur-xl opacity-0 group-hover:opacity-10 transition-opacity duration-500`}
            />
            <div className="relative bg-gray-900 rounded-lg sm:rounded-xl md:rounded-2xl p-2.5 sm:p-3 md:p-4 border border-dark-amber-700 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden h-full">
              <div className="absolute -right-1.5 -top-1.5 w-12 h-12 bg-gradient-to-br from-dark-amber-800/30 to-transparent rounded-full opacity-40 group-hover:scale-100 transition-transform duration-500" />
              <div className="flex flex-col h-full">
                ...
                <div className="mt-0.5 sm:mt-1 md:mt-2 flex-grow text-center sm:text-left">
                  <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-extrabold text-white tracking-tight leading-none">
                    {stat.value}
                  </h3>
                  <p className="text-[9px] sm:text-[10px] md:text-xs font-medium text-gray-400 mt-0.5 sm:mt-1 line-clamp-2">
                    {stat.label}
                  </p>
                </div>
                <div className="mt-1.5 sm:mt-2 md:mt-3 pt-1.5 sm:pt-2 border-t border-dark-amber-800">
                  <div className="flex items-center justify-between">
                    <div className="hidden xs:flex -space-x-1 sm:-space-x-1.5">
                      {[1, 2, 3].map((i) => (
                        <div key={i} className="w-3 h-3 sm:w-4 sm:h-4 rounded-full border border-gray-800 bg-dark-amber-700" />
                      ))}
                    </div>
                    <span className="text-[7px] sm:text-[8px] md:text-[10px] font-medium text-gray-500 italic">
      ...
      <section className="mb-4 sm:mb-6 md:mb-8 lg:mb-10">
        <div className="mb-3 sm:mb-4 md:mb-6">
          ...
          <p className="mt-1 text-xs sm:text-sm md:text-base text-gray-700 max-w-3xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 md:gap-5 lg:gap-6">
          {quickActions.map((action, index) => (
            <div key={index} className="relative group mobile-full-width">
              ...
              <div className="relative h-full bg-gray-900 rounded-xl sm:rounded-2xl border border-dark-amber-700 p-3 sm:p-4 md:p-5 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col">
                <div className="flex items-start gap-2.5 sm:gap-3 md:gap-4 mb-2.5 sm:mb-3 md:mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="text-sm sm:text-base md:text-lg font-bold text-white leading-tight mobile-text-truncate">
                      {action.title}
                    </h4>
                    <p className="mt-0.5 sm:mt-1 text-xs sm:text-sm text-gray-400 mobile-text-truncate">
                ...
                <p className="text-xs sm:text-sm text-gray-300 leading-relaxed flex-1 mb-3 sm:mb-4 md:mb-5 line-clamp-3 sm:line-clamp-4">
                  {action.description}
                </p>
                <button 
                  onClick={() => {
                  ...
                  className="mt-auto inline-flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-semibold text-dark-amber-400 hover:text-dark-amber-300 transition-colors mobile-touch-friendly"
                >
...
export default function ModernStudentPortalPage() {
  ...
  if (!student || !token) {
    const features = [
      { 
        icon: <FaBook className="w-4 h-4 sm:w-5 sm:h-5 text-dark-amber-600" />, 
      ...
      { 
        icon: <FaAward className="w-4 h-4 sm:w-5 sm:h-5 text-dark-amber-600" />, 
      ...
      { 
        icon: <FaChartBar className="w-4 h-4 sm:w-5 sm:h-5 text-dark-amber-600" />, 
      ...
      { 
        icon: <FaDollarSign className="w-4 h-4 sm:w-5 sm:h-5 text-dark-amber-600" />, 
      ...
      { 
        icon: <FaCalendar className="w-4 h-4 sm:w-5 sm:h-5 text-dark-amber-600" />, 
      ...
      { 
        icon: <FaComments className="w-4 h-4 sm:w-5 sm:h-5 text-dark-amber-600" />, 
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 font-sans overflow-x-hidden">
        ...
        <main className="relative z-10 flex flex-col min-h-screen">
          ...
          <nav className="sticky top-0 z-50 bg-gradient-to-r from-gray-950 via-gray-900 to-dark-amber-950 backdrop-blur-lg border-b border-dark-amber-700/30 px-3 py-2.5 sm:px-4 sm:py-3 md:px-6 md:py-4 lg:px-12">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
              <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3">
                <div className="relative">
                  <div className="absolute inset-0 bg-dark-amber-600/30 rounded-md blur-sm"></div>
                  <Image
                    src="/kinyui.png"
                ...
                <div>
                  ...
                  <span className="text-[7px] xs:text-[8px] sm:text-[9px] md:text-[10px] font-bold text-dark-amber-400 
              ...
              <div className="hidden md:flex items-center gap-4 lg:gap-6 xl:gap-8">
                <div className="flex items-center gap-1.5 px-2.5 py-1 bg-white/10 rounded-full border border-dark-amber-600/30">
                  <div className="w-1.5 h-1.5 bg-dark-amber-500 rounded-full animate-pulse" />
                  <span className="text-[10px] font-black text-dark-amber-300 uppercase tracking-wider">Secure Access</span>
                  <FaShieldHalved className="w-3 h-3 text-dark-amber-500" />
                </div>
                <button className="text-sm font-bold text-dark-amber-300 hover:text-white transition-colors">Support Center</button>
              </div>
              ...
              <button onClick={router.back} className="md:hidden flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 rounded-lg 
                ...
                <FaBars className="w-4 h-4 sm:w-5 sm:h-5 text-dark-amber-400" />
              </button>
            </div>
          </nav>
          ...
          <section className="px-3 xs:px-4 sm:px-6 md:px-8 lg:px-12 py-6 sm:py-8 md:py-12 lg:py-20 max-w-7xl mx-auto w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 xs:gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center">
              <div className="space-y-4 xs:space-y-5 sm:space-y-6 md:space-y-8">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-gray-800 rounded-lg border border-dark-amber-700 
                  text-[8px] xs:text-[9px] sm:text-[10px] font-bold tracking-widest uppercase text-dark-amber-400 whitespace-nowrap">
                  <HiSparkles className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-dark-amber-500" />
                  Excellence in Education Since 1976
                </div>
                <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 
                  font-black tracking-tighter leading-[0.85] xs:leading-[0.9] text-white">
                  SOARING  
                  <span className="block text-dark-amber-500 italic mt-1 xs:mt-2">To EXCELLENCE.</span>
                </h1>
                <p className="text-sm xs:text-base sm:text-lg md:text-xl text-gray-300 font-medium 
                ...
                <div className="flex flex-row items-center gap-2 sm:gap-4 w-full max-w-full">
                  <button
                    ...
                    className="flex-[2] sm:flex-none flex items-center justify-center gap-1.5 sm:gap-3 px-3 sm:px-8 py-2.5 sm:py-4 bg-gray-900 text-white rounded-xl sm:rounded-2xl font-black sm:font-bold text-[10px] sm:text-base uppercase sm:capitalize tracking-wider sm:tracking-normal hover:bg-dark-amber-800 transition-all duration-300 active:scale-95 shadow-md sm:shadow-xl group"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3 sm:px-7 py-2.5 sm:py-4 bg-gray-800 border border-dark-amber-700 text-dark-amber-400 rounded-xl sm:rounded-2xl font-black sm:font-bold text-[10px] sm:text-base uppercase sm:capitalize tracking-wider sm:tracking-normal hover:bg-gray-700 transition-all active:scale-95"
                  >
                    Get Help
                  </button>
                </div>
              ...
              <div className="relative group mt-4 xs:mt-6 sm:mt-0">
                <div className="absolute -inset-2 xs:-inset-3 sm:-inset-4 bg-dark-amber-900/40 rounded-[2rem] xs:rounded-[2.5rem] blur-xl xs:blur-2xl sm:blur-3xl opacity-40 group-hover:opacity-60 transition-opacity duration-300" />
                <div className="relative bg-gray-900 border border-dark-amber-700 shadow-lg xs:shadow-xl rounded-[1.5rem] xs:rounded-[2rem] sm:rounded-[2.5rem] p-4 xs:p-5 sm:p-6 md:p-8 space-y-4 xs:space-y-5 sm:space-y-6">
                  <div className="flex items-center justify-between border-b border-dark-amber-800 pb-3 xs:pb-4">
                    <h3 className="font-black text-xs xs:text-sm uppercase tracking-widest text-gray-400 whitespace-nowrap">
                      Portal Features
                    </h3>
                    <FaBrain className="w-4 h-4 xs:w-5 xs:h-5 text-dark-amber-500" />
                  </div>
                  <div className="space-y-3 xs:space-y-4">
                    <div className="p-3 xs:p-4 bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl xs:rounded-2xl border border-dark-amber-800">
                      <p className="text-[10px] xs:text-xs font-bold text-dark-amber-400 mb-0.5 xs:mb-1">Digital Library</p>
                      <p className="text-xs xs:text-sm font-semibold text-gray-300 leading-tight">
                        Access e-books, revision materials, and past papers.
                      </p>
                    </div>
                    <div className="p-3 xs:p-4 bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl xs:rounded-2xl border border-dark-amber-800">
                      <p className="text-[10px] xs:text-xs font-bold text-dark-amber-400 mb-0.5 xs:mb-1">Performance Dashboard</p>
                      <p className="text-xs xs:text-sm font-semibold text-gray-300 leading-tight">
                        Track your academic progress and KCSE preparedness.
                      </p>
                    </div>
                    <div className="p-3 xs:p-4 bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl xs:rounded-2xl border border-dark-amber-800">
                      <p className="text-[10px] xs:text-xs font-bold text-dark-amber-400 mb-0.5 xs:mb-1">Financial Dashboard</p>
                      <p className="text-xs xs:text-sm font-semibold text-gray-300 leading-tight">
                        View balances, statements, and payment records.
                      </p>
                    </div>
                  </div>
                  <button className="w-full py-2.5 xs:py-3 text-center text-[10px] xs:text-xs font-black uppercase tracking-widest text-gray-400 hover:text-dark-amber-500 transition-colors duration-300">
          ...
          <section className="bg-gradient-to-r from-gray-900 to-gray-800 border-y border-dark-amber-800 py-8 xs:py-12 sm:py-16 md:py-20 px-3 xs:px-4 sm:px-6 md:px-8 lg:px-12">
            <div className="max-w-7xl mx-auto">
              <div className="mb-6 xs:mb-8 sm:mb-10 md:mb-12 px-2">
                <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-black tracking-tight mb-1 xs:mb-2 text-white">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 xs:gap-4 sm:gap-5 md:gap-6 px-2">
                {features.map((feature, i) => (
                  <div key={i} className="group p-4 xs:p-5 sm:p-6 md:p-8 bg-gray-900 border border-dark-amber-700 rounded-[1.5rem] xs:rounded-[1.75rem] sm:rounded-[2rem] hover:shadow-xl hover:shadow-dark-amber-900/30 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300">
                    <div className="w-8 h-8 xs:w-9 xs:h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-r from-gray-800 to-gray-900 rounded-lg xs:rounded-xl sm:rounded-2xl flex items-center justify-center mb-3 xs:mb-4 sm:mb-6 group-hover:scale-105 transition-transform duration-300">
                      {feature.icon}
                    </div>
                    <h3 className="text-base xs:text-lg sm:text-xl md:text-2xl font-bold text-white mb-1.5 xs:mb-2 sm:mb-3 leading-tight">
                      {feature.title}
                    </h3>
                    <p className="text-gray-400 text-xs xs:text-sm leading-relaxed mb-3 xs:mb-4 sm:mb-6 line-clamp-2 xs:line-clamp-3">
                      {feature.desc}
                    </p>
                    <div className="flex items-center gap-1.5 xs:gap-2 text-[10px] xs:text-xs font-black uppercase tracking-widest text-gray-500 group-hover:text-dark-amber-500 transition-colors duration-300 cursor-pointer">
                      Login to Access 
          ...
          <footer className="px-3 xs:px-4 sm:px-6 md:px-8 lg:px-12 py-6 xs:py-8 sm:py-10 md:py-12 bg-gradient-to-r from-gray-950 to-dark-amber-950">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-6 xs:gap-8 sm:gap-10 md:gap-12">
              <div className="flex flex-col items-center lg:items-start gap-3 xs:gap-4 text-center lg:text-left">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 bg-white/10 rounded-lg flex items-center justify-center">
                    <FaSchool className="w-3 h-3 xs:w-3.5 xs:h-3.5 sm:w-4 sm:h-4 text-dark-amber-500" />
                  </div>
                  <span className="text-sm xs:text-base font-bold tracking-tight text-white">Kinyui Boys' Senior School</span>
                </div>
                <p className="text-[9px] xs:text-[10px] font-bold text-dark-amber-400 uppercase tracking-widest">
              ...
              <div className="flex flex-wrap justify-center gap-4 xs:gap-6 sm:gap-8 md:gap-10">
                <div className="space-y-1 xs:space-y-2 text-center">
                  <p className="text-[9px] xs:text-[10px] font-black text-dark-amber-400 uppercase tracking-widest">
                    Academics
                  </p>
                  <p className="text-xs font-bold text-white hover:text-dark-amber-400 cursor-pointer transition-colors duration-300">
                    KNEC Portal
                  </p>
                </div>
                <div className="space-y-1 xs:space-y-2 text-center">
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="flex">
        ...
        <div className="flex-1 flex flex-col min-h-screen w-full lg:w-[calc(100%-18rem)] xl:w-[calc(100%-20rem)] transition-all duration-300">
          ...
          <footer className="border-t border-dark-amber-800 bg-gradient-to-r from-gray-950 via-gray-900 to-dark-amber-950 py-4 sm:py-6 md:py-8">
            <div className="container mx-auto px-3 sm:px-4 md:px-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6">
                <div className="text-center md:text-left">
                  ...
                  <p className="text-dark-amber-400 text-xs mt-1 sm:mt-2">
                    Digital Student Portal • Empowering Excellence Through Technology
                  </p>
                  <div className="flex items-center gap-2 sm:gap-3 mt-2 sm:mt-3">
                    <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-gradient-to-r from-dark-amber-500 to-dark-amber-600 rounded-full animate-pulse"></div>
                    <span className="text-xs text-dark-amber-400">Secure Session Active</span>
                  </div>
                </div>
                <div className="flex items-center justify-center gap-4 sm:gap-6 flex-wrap">
                  <button
                    onClick={() => router.push('/pages/OurSchoolPolicies')}
                    className="text-dark-amber-400 hover:text-white text-xs sm:text-sm font-medium transition-colors mobile-touch-friendly"
                  >
                    Privacy Policy
                  </button>
                  ...
                  <button
                    onClick={() => router.push('/pages/OurSchoolPolicies')}
                    className="text-dark-amber-400 hover:text-white transition-colors mobile-touch-friendly"
